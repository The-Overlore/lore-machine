...
#     bound_handler = functools.partial(service, extra_argument={"mock": False})
...
# @pytest.mark.asyncio
# async def test_loop_with_mem(server):
#     async with websockets.connect("ws://localhost:8766") as websocket:
#         mock_data = '{"user": 1, "day": 0}'
#         # events = {} # Fetch 5 most important using day + id as input
#         villagers = {} # Fetch using realm ID
